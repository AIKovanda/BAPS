...
\begin{define}[Nevlastní hustota (apriorní)] Definujeme regulární hustotu (apost.??) vztahem
	$$\pi(\t|x)=\frac{f\cdot \pi}{\int f\pi\d\t}.$$
\end{define}
\begin{example}\begin{enumerate}[a)]
	...
	$$ \pi(\mu|x)=\frac{1}{c}f\cdot\pi=\frac{1}{c}\e{-\frac{1}{2}(x-\mu)^2}\e{-\frac{1}{20}(\mu-o)^2}=\frac{1}{c}\e{-\frac{11}{20}(\mu-\frac{10}{11}x)^2}.$$
	Pro odhad $mu$ pak platí, že
	$$\widehat{\mu}_B=\EE{\pi(\mu|x)}=\int\frac{1}{c}\e{????}\d\mu=\frac{1}{c''}$$ s~rozdělením $\NN\left(\frac{10}{11}x,\frac{10}{11}\right)$.
