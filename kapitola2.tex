		...
		\begin{enumerate}[a)]
			...
			\begin{figure}[h]
				...
				{\includegraphics[width=0.5\linewidth]{pictures/9_1.pdf}}
					\draw [color=black](4,-1) node[anchor=north west] {$ n = 4 $};
					\draw [color=black](4,-0) node[anchor=north west] {$ n = 1 $};
					\draw [color=black](1,1) node[anchor=north west] {$ n = 16 $};
					\draw [color=black](0.6,3) node[anchor=north west] {$ n \cdot \text{velké} $};
					\draw [color=black](5,1) node[anchor=north west] {$  \text{Beta}(\frac{1}{2},\frac{1}{2}) $};
					\draw [color=black](-3,-3) node[anchor=north west] {$ 0 $};
					\draw [color=black](-3,0) node[anchor=north west] {$ 0 ^1 / _2 $};
					\draw [color=black](-3,3) node[anchor=north west] {$ 0 1 $};
				\end{tikzpicture}
				\caption{popis}
				\label{fig:91}
			\end{figure}			
