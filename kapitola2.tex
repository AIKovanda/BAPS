...
\begin{example}
	...
	Se zadáním můžeme dělat několik věcí:\begin{enumerate}[1)]
		...
		$$ \widehat{p}_B=\underbrace{\frac{a+b}{a+b+n}}_{\alpha_n}\frac{a}{a+b}+\underbrace{\frac{n}{n+a+b}}_{1-\alpha_n}\frac{x}{n}=\alpha_n\widehat{p}_a+(1-\alpha_n)\widehat{p}_\mathrm{ML},$$ kde $\alpha_n$ se nazývá proce neurčitosti apriorní znalosti.
		\begin{enumerate}[a)]
...
{\Huge Zde by měly následovat dodatečně doplněné materiály k 12. přednášce.}
